"""Ordering-based causal graph structure for Causal SHAP computation."""
...
@dataclass
class OrderingGraph:
    """Ordering-based causal graph structure for Causal SHAP.
    ...
    Example:
        >>> from shapiq.causal import OrderingGraph
        >>> import numpy as np
        >>>
    ...
    See Also:
        ...
        :class:`~shapiq.causal.DAGGraph`: For do-Shapley (DAG-based).
    """
    ...
    def get_conditioning_set(
        ...
        Example:
            >>> graph = OrderingGraph([[0], [1, 2], [3]], [False, True, False])
...
CausalGraph = OrderingGraph
"""Alias for :class:`OrderingGraph` for backward compatibility.

.. deprecated::
    Use :class:`OrderingGraph` instead. This alias will be removed in a future version.
"""